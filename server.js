...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainComponent = __webpack_require__(153);

	var _MainComponent2 = _interopRequireDefault(_MainComponent);

	var _MapComponent = __webpack_require__(154);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainComponent = function (_React$Component) {
		...
		function MainComponent() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(MainComponent).call(this));
		}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"title",
							null,
							"Maps/mongodb/node geospatial example application"
						),
						_react2.default.createElement("link", { href: "https://fonts.googleapis.com/css?family=Roboto:400,300,500", rel: "stylesheet", type: "text/css" }),
						_react2.default.createElement("link", { rel: "stylesheet", type: "text/css", href: "http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" }),
						_react2.default.createElement("script", { src: "https://maps.googleapis.com/maps/api/js?key=AIzaSyCNjEAzE3PIfuRIX-c9WilAu8cb27ozXEg" }),
						_react2.default.createElement("script", { src: "https://cdnjs.cloudflare.com/ajax/libs/hammer.js/2.0.6/hammer.min.js" })
					),
					_react2.default.createElement(
						"body",
						null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapComponent = function (_React$Component) {
		...
		function MapComponent() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MapComponent).call(this));
		...
		_createClass(MapComponent, [{
			key: "addNearbyPoints",
			value: function addNearbyPoints() {
				...
				xhr.onreadystatechange = function () {
					if (xhr.readyState === 4 && xhr.status === 200) {
						(function () {
							...
							var markers = json.map(function (obj, i) {
								var marker = new google.maps.Marker({
	   ...
	   */
				...
				if (prevState.loadProgress !== this.state.loadProgress) {
					//do nothing
						...
						if (prevState.existingMarkers.length > 0) {
							prevState.existingMarkers.forEach(function (obj, i) {
								obj.setMap(null);
							});
						}
						if (this.state.existingMarkers.length > 0) {
							this.state.existingMarkers.forEach(function (obj, i) {
								obj.setMap(_this2.state.map);
							});
						}
					}
			}
			...
			key: "activateMapClick",
			value: function activateMapClick() {
				this.state.map.addListener('click', methods.mapClick.bind(this));
			}
				...
				if (!file) {
					...
					(function () {
						...
						if (objectid && objectid.pointid) {
							...
							if (_this5.state.currentPos) {
								data.append('title', _this5.state.currentPos.address);
								data.append('place_id', _this5.state.currentPos.id);
								data.append('lat', _this5.state.currentPos.lat);
								data.append('lng', _this5.state.currentPos.lng);
							}
						}
						var xhr = new XMLHttpRequest();
						xhr.onreadystatechange = function () {
							if (xhr.readyState === 4 && xhr.status === 200) {
								...
								var markers = _this5.state.existingMarkers;
								if (_this5.state.currentPos) {
									var newmarker = _this5.addMarker({
										_id: res._id,
										point: {
											coordinates: [_this5.state.currentPos.lng, _this5.state.currentPos.lat]
										}
									});
								...
								_this5.setState({
									...
									selectedPoint: null,
									loadProgress: 0,
									existingMarkers: markers }, function () {
			...
			key: "render",
			value: function render() {
				var lscreen = "loadscreen",
				    loadbar = "";
				if (this.state.loading) {
					lscreen = 'loadscreen visible';
				}
				if (this.state.loadProgress > 0) {
					loadbar = _react2.default.createElement(
						"div",
						{ className: "loadbar" },
						_react2.default.createElement("div", { style: { width: this.state.loadProgress + '%' } })
					);
				}
	   ...
	   if(this.state.currentPos) {
	   	thingToSeeDialog = <ThingToSeeDialog key="thingtosee" currentPos={this.state.currentPos} parent={this} />
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: lscreen, "data-progress": this.state.loadProgress },
						_react2.default.createElement(
							"div",
							{ className: "text" },
							"Loading. . ."
					...
					_react2.default.createElement(
						"div",
						{ className: "add", onClick: this.triggerFile.bind(this) },
						_react2.default.createElement("div", { className: "ion-plus" }),
						_react2.default.createElement("input", { type: "file", name: "image", onChange: this.change.bind(this) })
					),
	...
	var methods = {
		...
		mapClick: function mapClick(evt) {
			var _this6 = this;
			...
			this.setState({
				...
				methods.geocode.call(_this6, { lat: evt.latLng.lat(), lng: evt.latLng.lng() });
			});
		...
		markerClick: function markerClick(cb) {
			var id = this._id;
			var xhr = new XMLHttpRequest();
			xhr.onreadystatechange = function () {
				if (xhr.readyState === 4 && xhr.status === 200) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var trans = _tools2.default.Transitions();

	var PointscreenComponent = function (_React$Component) {
		_inherits(PointscreenComponent, _React$Component);

		function PointscreenComponent(props) {
			_classCallCheck(this, PointscreenComponent);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PointscreenComponent).call(this, props));
		...
		_createClass(PointscreenComponent, [{
			key: "componentDidMount",
			value: function componentDidMount() {
				var th = this;
				trans.flipout('.pointscreen', {
					after: function after(hammer) {
			...
			key: "closePointscreen",
			value: function closePointscreen() {
			...
			value: function addImage(e) {
				...
				var file = e.target.files[0];
				var objectid = e.target.getAttribute('data-objectid');

				this.props.parent.setState({
					file: file
				}, function () {
					_this2.props.parent.save.call(_this2.props.parent, { pointid: objectid });
				});
			}
		}, {
			key: "openImage",
			value: function openImage(e) {
				this.setState({
					currentImage: {
			...
			value: function render() {
				...
				var renderImages = function renderImages(obj, i) {
					var style = {
						backgroundImage: 'url(/uploads/point-' + _this3.state.currentPointId + '/small-' + obj.name + ')'
					};
					return _react2.default.createElement("div", { onClick: _this3.openImage.bind(_this3), className: "image", "data-id": obj._id, "data-name": obj.name, key: obj._id, style: style });
				};
				...
				if (this.state.currentImage) {
					...
					imageview = _react2.default.createElement(
						"div",
						{ className: "imageview", style: style },
						_react2.default.createElement("div", { className: "ion-close", onClick: this.closeImage.bind(this) })
					);
				}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: "add", onClick: this.props.parent.triggerFile.bind(this.props.parent) },
							_react2.default.createElement("div", { className: "ion-plus" }),
							_react2.default.createElement("input", { type: "file", name: "image", "data-objectid": this.props.parent.state.selectedPoint._id, onChange: this.addImage.bind(this) })
						)
					)
				);
			}
	...
	var tools = {
		...
		Transitions: function Transitions() {
			return {
				...
				flipout: function flipout(elmnt, opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parsefile = function parsefile(name, id) {
		...
		(0, _sharp2.default)(imgpath + name).resize(200, 200).toFile(imgpath + 'point-' + id + '/small-' + name, function (err) {
			// output.jpg is a 300 pixels wide and 200 pixels high image
			// containing a scaled and cropped version of input.jpg
		});
		(0, _sharp2.default)(imgpath + name).resize(1600).toFile(imgpath + 'point-' + id + '/standard-' + name, function (err) {
			// output.jpg is a 300 pixels wide and 200 pixels high image
			// containing a scaled and cropped version of input.jpg
		});
	};
	...
	apirouter.post('/nearbypoints', function (req, res, next) {
		...
		_db2.default.getNearbyPoints({ lat: lat, lng: lng }, function (err, result) {
			if (err) {
	...
	apirouter.get('/point/:id', function (req, res, next) {
		...
		_db2.default.getPoint(id, function (err, result) {
			res.json(result);
		});
	});
	...
	apirouter.post('/point/:id', upload.single('file'), function (req, res, next) {
		...
		if (req.file.filename) {
			...
			var status = _db2.default.updatePoint({
				_id: id,
				image: {
	...
	apirouter.post('/point', upload.single('file'), function (req, res, next) {
		...
		if (req.file.filename) {
			...
			var status = _db2.default.createPoint({
				_id: _id,
				place_id: place_id,
				lat: lat,
				lng: lng,
...
/***/ function(module, exports, __webpack_require__) {
	...
	_mongoose2.default.connect('mongodb://localhost/sightsseen');
	var Schema = _mongoose2.default.Schema;

	var Point = _mongoose2.default.model('Point', { place_id: { type: String, unique: true }, point: { type: Schema.Types.Mixed, index: '2dsphere' }, name: String, images: Array });
	var Image = _mongoose2.default.model('Image', { name: String, date: { type: Date, default: Date.now } });
	...
	var methods = {
		...
		updatePoint: function updatePoint(data) {
			var image = new Image({
				name: data.image.name
			});
		...
		getNearbyPoints: function getNearbyPoints(pos, cb) {
		...
		getPoint: function getPoint(id, cb) {
